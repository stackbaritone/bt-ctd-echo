...
(function(){
  ...
  function buildJsonUrlCandidates(options={}){
    ...
    const ghPagesUrl = 'https://stackbaritone.github.io/bt-ctd-echo/complete_email_templates.json';
    ...
    btnGenerateWord.onclick = async () => {
      ...
      try {
        ...
        if (audience === 'conseillers') {
          ...
          // Templates that include 'equipe_admin' mode
          filteredData.templates = data.templates.filter(t => hasMode(t, 'equipe_admin'));
