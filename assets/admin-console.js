...
(function () {
  ...
  viewTemplates.innerHTML = `
      ...
      <div class="field">
        ...
        <div style="background:#fef3c7;border:1px solid #f59e0b;border-radius:8px;padding:10px;margin:6px 0 10px;">
          <div style="display:flex;align-items:start;gap:8px;">
            <span style="font-size:18px;line-height:1;">⚠️</span>
            <div style="font-size:12px;line-height:1.4;">
              <strong>Important:</strong> Les placeholders doivent utiliser le nom exact (même casse) des variables listées ci-dessous. 
              N'utilisez <strong>PAS</strong> de suffixes <code>_FR</code> ou <code>_EN</code>. 
              <br>Ex: utilisez <code>&lt;&lt;clientname&gt;&gt;</code> et non <code>&lt;&lt;clientname_FR&gt;&gt;</code> ou <code>&lt;&lt;ClientName&gt;&gt;</code>
            </div>
          </div>
        </div>
  ...
  async function githubPublishFlow() {
    try {
      ...
      const repo = 'stackbaritone/bt-ctd-echo'; // adjust if forked
  ...
  if (btnHelp) btnHelp.onclick = () => {
    ...
    const body = `
      <div style="display:grid; gap:12px;">
        ...
        <section>
          <div class="hint" style="font-weight:800;color:#334155">⚠️ IMPORTANT: Nommage des variables</div>
          <ul style="margin:6px 0 0 18px;">
            <li><strong>Les noms de variables dans les placeholders doivent correspondre EXACTEMENT</strong> (incluant la casse) avec les entrées dans le tableau <code>variables</code> du modèle.</li>
            <li><strong>N'utilisez PAS de suffixes linguistiques</strong> comme <code>_FR</code> ou <code>_EN</code> dans les placeholders. Utilisez uniquement le nom de base de la variable.</li>
            <li><strong>Convention de nommage:</strong> minuscules avec underscores (ex: <code>clientname</code>, <code>project_id</code>, <code>nb_days</code>).</li>
            <li><strong>Exemples corrects:</strong>
              <ul style="margin:4px 0 0 18px;">
                <li>✅ Placeholder: <code><<clientname>></code> → Variables: <code>["clientname"]</code></li>
                <li>✅ Placeholder: <code><<project_number>></code> → Variables: <code>["project_number"]</code></li>
              </ul>
            </li>
            <li><strong>Exemples incorrects:</strong>
              <ul style="margin:4px 0 0 18px;">
                <li>❌ Placeholder: <code><<clientname_FR>></code> → Variables: <code>["clientname"]</code></li>
                <li>❌ Placeholder: <code><<ID>></code> → Variables: <code>["id"]</code> (casse différente)</li>
              </ul>
            </li>
            <li><strong>Pourquoi c'est important:</strong> L'éditeur détachable (popout) et la fonctionnalité de remplacement de variables dépendent d'une correspondance exacte. Des noms incohérents empêcheront les variables de s'afficher ou de fonctionner correctement.</li>
          </ul>
        </section>
      </div>`;
